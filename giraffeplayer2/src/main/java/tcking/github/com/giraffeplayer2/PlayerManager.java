...
public class PlayerManager {
    ...
    private WeakReference<AppCompatActivity> topActivityRef;
    ...
    private GiraffePlayer createPlayer(VideoView videoView) {
        ...
        registerActivityLifecycleCallbacks(((AppCompatActivity) videoView.getContext()).getApplication());
        ...
        if (topActivityRef == null || topActivityRef.get() == null) {
            topActivityRef = new WeakReference<>((AppCompatActivity) videoView.getContext());
        }
        return player;
    }
...
//                System.out.println("======onActivityResumed============"+activity);
                ...
                topActivityRef = new WeakReference<AppCompatActivity>((AppCompatActivity) activity);
            }
